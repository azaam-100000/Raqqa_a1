const CACHE_NAME = 'raqqa-market-cache-v12'; // Bump version to force update
...
self.addEventListener('install', event => {
  console.log('Service Worker: Install Event v12');
...
self.addEventListener('activate', event => {
  console.log('Service Worker: Activate Event v12');
  event.waitUntil(
    caches.keys().then(cacheNames => {
      ...
      console.log('Service Worker: Claiming clients v12');
