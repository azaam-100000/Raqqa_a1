                            ...
                            <div className="absolute left-2" ref={menuRef}>
                                ...
                                {isMenuOpen && (
                                    <div className="absolute left-0 mt-2 w-48 bg-slate-700 border border-slate-600 rounded-md shadow-lg z-10">
                                        <button onClick={handleDeleteGroup} className={`block w-full text-right px-4 py-2 text-sm hover:bg-slate-600 transition-colors ${confirmingDelete ? 'bg-red-700 text-white' : 'text-red-400'}`}>
