...
import CreateProductCommentForm from './CreateProductCommentForm';
...
const ReplyIcon = () => ( <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M9 14 4 9l5-5"/><path d="M4 9h12a6 6 0 0 1 6 6v4"/></svg> );
...
const ProductCommentCard: React.FC<ProductCommentCardProps> = ({ comment, productOwnerId, onCommentCreated, onCommentUpdated, onCommentDeleted }) => {
    const { user } = useAuth();
    ...
    return (
        <div>
            ...
            {comment.replies && comment.replies.length > 0 && (
                <div className="pt-3 ml-6 pl-4 border-l-2 border-gray-200 dark:border-zinc-700 space-y-3">
