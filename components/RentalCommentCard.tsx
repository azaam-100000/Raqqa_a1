...
import CreateRentalCommentForm from './CreateRentalCommentForm';
...
const RentalCommentCard: React.FC<RentalCommentCardProps> = ({ comment, postOwnerId, onCommentCreated, onCommentUpdated, onCommentDeleted }) => {
    const { user } = useAuth();
